...
urlpatterns = [
    ...
    path('answer_start/<int:quiz>/<int:question>/', AnswerStartView.as_view(), name = 'answer_start'),
    path('answer_resume/<int:quiz>/<int:question>/', AnswerResumeView.as_view(), name = 'answer_resume'),
